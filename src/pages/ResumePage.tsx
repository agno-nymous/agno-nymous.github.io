...
export function ResumePage() {
  return (
    <section className="container mx-auto px-6 py-20">
      ...
      >
        <div className="bg-card rounded-3xl p-10 border border-theme shadow-lg">
          <div className="text-center mb-8">
            <motion.a 
              href="/Ashish-Thomas-Chempolil-FlowCV-Resume-7Jul2025.pdf"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 btn-primary rounded-2xl font-bold text-xl shadow-lg hover:shadow-xl transition-all"
          ...
          <div className="w-full h-[800px] border border-theme rounded-2xl overflow-hidden bg-white">
            <iframe
